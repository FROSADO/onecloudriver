// Package types defines the shared interfaces between internal packages
// of the project, avoiding circular dependencies.
package types

import "context"

// TokenProvider is an interface for anything that can provide
// a Microsoft Graph access token.
//
// This interface allows the graph package to work with tokens without
// directly depending on the auth package, avoiding import cycles.
//
