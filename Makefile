.PHONY: build test test-unit test-integration test-all bench crash-sim clean lint lint-all lint-security setup-fuse security-audit dist deb rpm release release-check docs help
# ──── Variables ────
